                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="row" style="margin-bottom: 2px">
                                ...
                                <div class="col text-right text-bottom" style="font-size: xx-small;color:black ; margin-top:8px">{{$articlebycategories->vendeur->nom}}</div>
                            </div>
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="{{asset('storage/'.$articlebycategories->image )}}" alt="">
                            </div>
                            ...
                            <?php
                                $x=(string)$articlebycategories->vendeur->contact;
                                $y='299'.$x;
                            ?>
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <a href="{{ route('details',$articlebycategories->id) }}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Détails</a>
